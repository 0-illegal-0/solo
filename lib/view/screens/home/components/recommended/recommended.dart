...
class Recommended extends StatelessWidget {
  Recommended({Key? key, this.width, this.title, this.data, this.padding})
      : super(key: key);
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        width: width! * 0.20,
                        height: width! * 0.025 < 25 ? 25 : width! * 0.025,
                        alignment: Alignment.center,
                        color: const Color(0xFFffffff),
                        child: Text("Best laptops in 2023",
                            textAlign: TextAlign.center,
                            style: TextStyle(
