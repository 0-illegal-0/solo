...
class LaptopViewController extends MoveSliderMain {
  LaptopViewController({this.itemsList, this.width});
  double? width;
  List? itemsList;
}

class LaptopItems extends StatelessWidget {
  LaptopItems(
      {Key? key,
      this.itemList,
      this.width,
  ...
  Widget build(BuildContext context) {
    SizesData instanceSizes = SizesData(
        ...
        mainPadding: mainPadding,
        width: width);
    LaptopViewController controller =
        Get.put(LaptopViewController(itemsList: itemList, width: width));
    return Column(
      ...
      children: [
        ...
        SizedBox(
          ...
          child: Stack(
            ...
            (index) => GetBuilder<LaptopViewController>(builder: (context) {
