                ...
                children: [
                  Wrap(
                      ...
                      children: List.generate(
                          data!.length > 4 ? 4 : data!.length, (index) {
                        return index < 3
                            ? SpecialOfferItem(
                                loopIndex: index,
                                ...
                                width: width!,
                                beforeDiscount: data![index]["item"].price!,
                                afterDicount: data![index]["item"].price!,
                                discount: data![index]["item"].discount!,
                                specialOfferImage: data![index]["item"].image!,
                                specialOfferTitle: data![index]["item"].title!,
                                  ...
                                  (index2) => Expanded(
                                    child: Padding(
                                      ...
                                      child: SpecialOfferItem(
                                          ...
                                          mainPadding: mainPadding!,
                                          width: width!,
                                          index: data![index + index2]["index"],
                                          productItem: data![index + index2]
                                              ["product-index"],
                                          aspectRatio: data![index + index2]
                                              ["aspectRatio"],
                                          height: data![index + index2]
                                              ["height"],
                                          itemList: data![index + index2]
                                              ["item-list"],
                                          beforeDiscount: data![index + index2]
                                                  ["item"]
                                              .price!,
                                          afterDicount: data![index + index2]
                                                  ["item"]
                                              .price!,
                            ...
                            children: [
                              Expanded(
                                child: Padding(
                                  ...
                                  child:
                                      Image.asset(data![index]["item"].image!),
                                ),
                              ),
                              Padding(
                                padding:
                                    ...
                                    child: IconButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        controller.addToCart(
                                            context: context,
                                            image: data![index]["item"].image!,
                                            price: data![index]["item"].price!,
                                            stars: data![index]["item"].stars,
